...
void ZChillerLogUI::ZDoInitial()
{
    ...
    this->m_treeWidget->setHeaderLabels(QStringList()<<tr("DateTime(时间)")<<tr("Module(模块)")<<tr("LogType(类型)")<<tr("LogMsg(事件)"));
    this->m_treeWidget->setColumnWidth(0,150);
    this->m_treeWidget->setColumnWidth(1,100);
    this->m_treeWidget->setColumnWidth(2,100);
...
void ZChillerLogUI::ZSloExport()
{

}
void ZChillerLogUI::ZSloDelete()
{

}
void ZChillerLogUI::ZFetchLogs()
{
