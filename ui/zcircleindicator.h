#ifndef ZCIRCLEINDICATOR_H
#define ZCIRCLEINDICATOR_H
...
#include <QWidget>
#include <QTimer>
class ZCircleIndicator : public QWidget
{
    Q_OBJECT
public:
    explicit ZCircleIndicator(QString title,QWidget *parent = 0);
